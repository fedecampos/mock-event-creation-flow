  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild disabled={disabled}>
        <button
          className={cn(
            "flex-1 h-12 md:h-10 bg-light-gray rounded-[14px] md:rounded-[10px] flex items-center justify-center px-4 gap-1 overflow-hidden transition-colors duration-200 ease",
            disabled
